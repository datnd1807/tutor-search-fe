    ...
    <div class="card shadow" :class="type === 'dark' ? 'bg-default' : ''">
      ...
      <div class="table-responsive">
        <el-table :data="pagedTableData" border stripe height="580px">
          ...
          <el-table-column prop="updatedDate" label="Create Date" align="center" :formatter="dateFormat">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...mapActions(["getAllClassesAction"]),

    async init() {
      const data1 = await this.getAllClassesAction();
    },
